...
<section class="contact-us free-quote bg-blue-red pd-a-50">
	...
	<div class="container bg-white-op-6 bdr-3 ">
		...
		<div class="section-description text-center">
			<p>To Explore how we can help you create a sales weapon that’ll capture and convert more customers, fill out your details below and we’ll be in touch within the next two hours.</p>
		</div>
		<div class="row">
			<!--   Contact Form Star  -->
		...
		<div class="row">
			<div class="col-md-10 mx-auto contact-body">
				<form class="contact-form" action="#" method="post" id="free-quote" enctype="multipart/form-data">
				    ...
				    <div class="row">
						<div class="col-md-12  mb-3">
							<input type="file" name="project_file" class="form-control" placeholder="Upload file">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12  mb-3">
