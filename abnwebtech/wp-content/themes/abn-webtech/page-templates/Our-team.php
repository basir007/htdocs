				...
				<div class="row">
					<div class="col-md-4">
						<div class="logo-demo">
							...
							<div class="logo-for">Nasiruddin Khan </div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="logo-demo">
							...
							<div class="logo-for">Basiruddin Khan </div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="logo-demo">
							...
							<div class="logo-for">Koushik Ghosh </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="logo-demo">
							<img src="<?php bloginfo('template_directory');?>/images/Logo-design-company-Kolkata-Akbar-webetch.jpg" >
							<div class="logo-for">Priobrata Goswami </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="logo-demo">
							<img src="<?php bloginfo('template_directory');?>/images/Logo-design-company-Kolkata-Akbar-webetch.jpg" >
							<div class="logo-for">Sumon Ray </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="logo-demo">
							<img src="<?php bloginfo('template_directory');?>/images/Logo-design-company-Kolkata-Akbar-webetch.jpg" >
							<div class="logo-for">Asraf Ali </div>
						</div>
					</div>
